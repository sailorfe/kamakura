...
(defvar kamakura/palette
  (let* (
         ...
         ;; accents
         (miko (kamakura/hsl 352 0.76 0.38)) ; red
         (yorishige (kamakura/hsl 114 0.50 0.36)) ; green
         (mima (kamakura/hsl 44 0.75 0.46)) ; gold
         (tokiyuki (kamakura/hsl 263 0.33 0.61)); purple
         ...
         (hojo (kamakura/bright 263 0.33 0.61 0.1))
...
(let* ((base (alist-get 'base kamakura/palette))
       ...
       (miko (alist-get 'miko kamakura/palette))
       (yorishige (alist-get 'yorishige kamakura/palette))
       (mima (alist-get 'mima kamakura/palette))
       (tokiyuki (alist-get 'tokiyuki kamakura/palette))
       (ayako (alist-get 'ayako kamakura/palette))
       (shizuku (alist-get 'shizuku kamakura/palette))
       (taisha (alist-get 'taisha kamakura/palette))
       (suwa (alist-get 'suwa kamakura/palette))
       (sasaki (alist-get 'sasaki kamakura/palette))
       (hojo (alist-get 'hojo kamakura/palette))
       (mochizuki (alist-get 'mochizuki kamakura/palette))
       (kami (alist-get 'kami kamakura/palette)))
